...
<body>
    <div class="w-full max-w-2xl mx-auto p-8">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <!-- Form -->
            <form action="/hebergeur/hebergement/store" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-6">
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" name="nom_hotel" id="nom_hotel" placeholder="Titre de l'annonce" 
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="number" name="prix_nuit" id="prix_nuit" placeholder="Prix par nuit" 
                                   class="w-full py-3 px-4 border border-gray-400 rounded-lg focus:outline-none focus:border-blue-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="number" name="nombre_chambre" id="nombre_chambre" placeholder="Nombre de chambres" 
                                   class="w-full py-3 px-4 border border-gray-400 rounded-lg focus:outline-none focus:border-blue-500">
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="number" name="nombre_salle_debain" id="nombre_salle_debain" placeholder="Nombre de salles de bain" 
                                   class="w-full py-3 px-4 border border-gray-400 rounded-lg focus:outline-none focus:border-blue-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="hidden">
                    ...
                    <input type="hidden" name="hebergeur_id" value="{{ auth()->check() ? auth()->user()->id : '' }}">
                </div>
