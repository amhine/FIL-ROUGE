        ...
        <div class="w-full flex justify-center p-6">
            <div class="w-full max-w-screen-xl">
                <div class="flex flex-wrap -mx-2">
                    @foreach($stade as $key => $stades)
                        <div class="w-full md:w-1/3 px-2 mb-4">
                            <div class="bg-white shadow-lg rounded-2xl overflow-hidden p-2 h-full">
                                <h1 class="text-2xl font-bold text-red-600 p-2">{{ $stades->nom_stade }}</h1>
                                
                                <div class="relative w-full py-2 overflow-hidden">
                                    <img src="{{ $stades->image }}" alt="{{ $stades->nom_stade }}" class="w-full h-48 object-cover rounded-xl">
                                </div>
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="flex items-center text-gray-700 mt-2">
                                        ...
                                        <span>Capacité: {{ $stades->capaciter }}</span>
                                    </div>
        
                                    <a href="#" class="block mt-4 text-center bg-red-600 text-white py-2 px-4 rounded-lg hover:bg-red-700 transition">
                                        Voir Les Détails
                                    </a>
                                </div>
                            </div>
