...
<div class="w-full flex justify-center p-6">
    <div class="w-full max-w-screen-lg bg-white shadow-lg rounded-2xl overflow-hidden p-2">
        <h1 class="text-4xl font-bold text-red-600 p-2 ml-6">{{ $stades->nom_stade }}</h1>
        
        <div class="relative w-full py-4 overflow-hidden">
            <img src="{{ $stades->image }}" alt="{{ $stades->nom_stade }}" class="w-full h-64 object-cover rounded-xl">
        </div>
